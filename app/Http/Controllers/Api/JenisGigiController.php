...
class JenisGigiController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['status' => 'success', 'pesan' => 'Data jenis_gigi dinonaktifkan!']);
    }

    public function semua()
    {
        return response()->json(['status' => 'success', 'data' => JenisGigi::onlyTrashed()->orderBy('id', 'desc')->get()]);
    }
    ...
    public function restore($id)
    {
        ...
        return response()->json(['status' => 'success', 'pesan' => 'Data jenis_gigi berhasil diaktifkan kembali!']);
    }
}
