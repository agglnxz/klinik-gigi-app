        ...
        <form action="#" method="POST" id="editForm">
            ...
            <div class="space-y-6 mb-12">
                ...
                <div>
                    ...
                    <input type="text" name="nama_pasien" id="nama_pasien" value="Yossy Fira Rosdiana" placeholder="Masukkan Nama Sesuai KTP"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_rm" id="no_rm" value="RM-2026-0410" readonly
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <label class="flex-1 flex items-center justify-start px-4 py-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition border border-transparent">
                                <input type="radio" name="jenis_kelamin" value="Perempuan" checked class="w-4 h-4 text-teal-600 focus:ring-teal-500 border-gray-300">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="2000-05-20" placeholder="DD/MM/YYYY"
                            class="w-full px-4 py-3 bg-gray-50 border-none rounded-lg focus:ring-2 focus:ring-teal-500 focus:shadow-md text-sm text-gray-600 placeholder-gray-400 transition">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_handphone" id="nomor_handphone" value="081234567892" placeholder="0812-3456-7890"
                            class="w-full px-4 py-3 bg-gray-50 border-none rounded-lg focus:ring-2 focus:ring-teal-500 focus:shadow-md text-sm text-gray-600 placeholder-gray-400 transition">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="4" placeholder="Masukkan Alamat Lengkap Domisili saat ini..."
                        class="w-full px-4 py-3 bg-gray-50 border-none rounded-lg focus:ring-2 focus:ring-teal-500 focus:shadow-md text-sm text-gray-600 placeholder-gray-400 transition resize-none">Jl. Merdeka No. 123, Kota Bandung</textarea>
                </div>
