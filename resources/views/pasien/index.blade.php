...
@section('content')
    <div class="space-y-6">
        ...
        @if (session('success'))
            <div
                class="p-4 bg-teal-50 border border-teal-200 text-teal-700 rounded-xl text-sm mb-4 flex items-center shadow-sm">
                    ...
                    <thead>
                        <tr class="bg-[#F3F4F3] border-b border-gray-100">
                            <th class="w-[250px] px-8 py-4 text-[11px] font-bold text-bold-900 uppercase tracking-widest">
                                Nama Pasien</th>
                            <th class="w-[150px] px-8 py-4 text-[11px] font-bold text-bold-900 uppercase tracking-widest">
                                No. Rekam Medis</th>
                            <th class="w-[150px] px-8 py-4 text-[11px] font-bold text-bold-900 uppercase tracking-widest">
                                Jenis Kelamin</th>
                            <th class="w-[150px] px-8 py-4 text-[11px] font-bold text-bold-900 uppercase tracking-widest">
                            ...
                            <tr class="hover:bg-gray-50/30 transition">
                                <td class="px-8 py-6">
                                    <div class="flex items-center space-x-3">
                                        <div
                                            class="w-10 h-10 rounded-lg bg-teal-100 text-teal-700 flex items-center justify-center font-bold text-xs uppercase">
                                            YF</div>
                                        <div>
                                ...
                                <td class="px-8 py-6">
                                    @if ($item->is_aktif)
                                        <span
                                            class="px-3 py-1 bg-teal-100 text-teal-600 text-[10px] font-bold rounded-full uppercase shadow-sm">Aktif</span>
                                    @else
                                        <span
                                            class="px-3 py-1 bg-red-100 text-red-500 text-[10px] font-bold rounded-full uppercase shadow-sm">Nonaktif</span>
                                    @endif
                                </td>
                                <td class="px-8 py-6">
