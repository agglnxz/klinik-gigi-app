...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-end mb-6">
        <div>
            <h3 class="text-lg font-bold text-black-1000">Daftar Dokter Spesialis</h3>
            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Total 12 Tenaga Medis</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-[#F3F4F3] border-b border-gray-100">
                        <th class="w-[250px] px-8 py-4 text-[11px] font-bold text-bold-900 uppercase tracking-widest">Nama Dokter</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/30 transition border-b-0">
        ...
        <div class="bg-[#F3F4F3] px-8 py-4 border-t border-gray-100">
            <p class="text-[11px] text-gray-400 font-medium">Menampilkan 3 dari 12 Dokter</p>
        </div>
    </div>
