            ...
            <table class="w-full text-left border-collapse min-w-[1000px]">
                <thead>
                    <tr class="bg-[#F3F4F3] border-b border-gray-100">
                        ...
                        <th class="w-[200px] px-8 py-4 text-[11px] font-bold text-bold-900 uppercase tracking-widest">Nomor HP</th>
                ...
                <tbody class="divide-y divide-gray-50 text-sm">
                    ...
                    <tr class="hover:bg-gray-50/30 transition">
                        ...
                        <td class="px-8 py-6 text-gray-600 font-medium">{{ $item->alamat }}</td>
                        ...
                        <td class="px-8 py-6">
                            <div class="flex space-x-2">
                                ...
                                @else
                                    ...
                                    <button type="button"
                                        @click="$dispatch('buka-modal-hapus', { id: '{{ $item->id }}', nama: '{{ $item->nama_lab }}', tabel: 'laboratorium' })"
                    ...
                    <tr>
                        <td colspan="5" class="px-8 py-20 text-center">
                            <div class="flex flex-col items-center opacity-40">
                                <i class="fa-solid fa-flask text-5xl mb-4"></i>
                                <p class="text-sm font-medium">Belum ada data laboratorium yang terdaftar</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
<div x-data="{ open: false, idReferensi: '', namaData: '', namaTabel: '', alasan: '' }"
    ...
    <div @click.outside="open = false"
        ...
        <div class="flex items-center gap-3 text-red-500 mb-4">
            ...
            <h3 class="text-base font-bold text-gray-800">Pengajuan Hapus Laboratorium</h3>
        </div>

        <p class="text-xs text-gray-500 mb-4 leading-relaxed">
            Anda mengajukan penghapusan untuk mitra laboratorium: <span class="font-bold text-gray-800" x-text="namaData"></span>. Data tidak akan langsung terhapus sebelum disetujui oleh Direktur.
        </p>
        ...
        <form :action="'{{ route('pengajuan-hapus.store') }}'" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="alasan_hapus" x-model="alasan" required rows="3"
                    placeholder="Tulis alasan mengapa kemitraan laboratorium ini diajukan untuk dihapus..."
