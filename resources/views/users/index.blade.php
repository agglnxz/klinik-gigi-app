...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
            ...
            <tbody class="divide-y divide-gray-50 text-xs text-gray-600">
                ...
                <tr class="hover:bg-gray-50/40 transition">
                    ...
                    <td class="px-6 py-5">
                        <div class="flex">
                            @if($user->is_aktif)
                                <span class="px-2.5 py-0.5 bg-[#E6F4EA] text-[#137333] rounded text-[10px] font-bold uppercase tracking-wide">
                                    Aktif
                                </span>
                            @else
                                <span class="px-2.5 py-0.5 bg-red-100 text-red-600 rounded text-[10px] font-bold uppercase tracking-wide">
                                    Nonaktif
                                </span>
                            @endif
                        </div>
                        ...
                        <div class="flex space-x-2">
                            ...
                            <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                                ...
                                <button type="submit"
                                    ...
                                    class="flex items-center px-4 py-2 bg-[#d65f5f] text-white text-xs font-bold rounded-md hover:bg-[#b54d4d] transition shadow-md hover:shadow">
    ...
    <div class="bg-[#F3F4F3] px-8 py-4 border-t border-gray-100">
        <p class="text-[11px] text-gray-400 font-medium"> Menampilkan {{ $users->count() }} User Saat Ini</p>
    </div>
</div>
