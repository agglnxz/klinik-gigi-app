...
@section('content')
    ...
    <div class="bg-[#f0f9f4] p-8 rounded-2xl flex justify-between items-center shadow-sm border border-gray-100">
        <div class="max-w-md">
            ...
            <button class="mt-6 bg-[#1b5e4b] text-white px-6 py-2 rounded-lg font-semibold">Mulai Pemeriksaan Baru</button>
        </div>
